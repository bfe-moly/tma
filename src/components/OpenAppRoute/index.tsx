...
const CDN_URL = '/tma/by_appsflyer_c67e7b7d.js';
    ...
    <div style={{ color: '#000' }}>
      <Space direction="vertical">
        <Button
          color="success"
          onClick={() =>
            openApp('bybitapp://open/home?tab=2&symbol=BTCUSDT&page=trading')
          }
        >
          打开合约
        </Button>
        <Button
          color="success"
          onClick={() => openApp('bybitapp://open/home?tab=3&symbol=BTCUSDT')}
        >
          打开现货
        </Button>
        <Button
          color="success"
          onClick={() => openApp('by-mini://trading_bot/createGridBot')}
        >
          打开小程序-现货网格
        </Button>
      </Space>
